...
**YOU ARE IN: `sandtown/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/sandtown/` (rig root) or other directories
...
**Your mail address:** `sandtown/polecats/furiosa`
**Your rig:** sandtown
**Your Witness:** `sandtown/witness`
...
| Ask Witness for help | `gt mail send sandtown/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`sandtown/witness`) when:
...
```bash
gt mail send sandtown/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```

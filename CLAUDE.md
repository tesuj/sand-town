...
**YOU ARE IN: `sand_town/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/sand_town/` (rig root) or other directories
...
**Your mail address:** `sand_town/polecats/rust`
**Your rig:** sand_town
**Your Witness:** `sand_town/witness`
...
| Ask Witness for help | `gt mail send sand_town/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`sand_town/witness`) when:
...
```bash
gt mail send sand_town/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
